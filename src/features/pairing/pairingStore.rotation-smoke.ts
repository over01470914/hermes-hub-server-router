...
assert.match(hostileRequest.prompt, /Use the official CLI below\. Execute the install command, then run pair once/)
assert.match(hostileRequest.prompt, /request native approval for that exact command/)
assert.match(hostileRequest.prompt, /Return the CLI output unchanged/)
assert.match(hostileRequest.prompt, /Expires at \(UTC\): 1970-01-01T00:46:40\.000Z/)
