...
assert.match(hostileRequest.prompt, /hermes skills install "https:\/\/raw\.githubusercontent\.com\/over01470914\/hermes-hub-gateway-plugin\/main\/skills\/hermes-hub-gateway-pair\/SKILL\.md" --yes/)
