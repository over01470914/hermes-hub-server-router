...
assert.match(hostileRequest.prompt, /Load `hermes-hub-gateway-pair`/)
assert.match(hostileRequest.prompt, /hermes skills install "https:\/\/raw\.githubusercontent\.com\/over01470914\/hermes-hub-gateway-plugin\/main\/skills\/hermes-hub-gateway-pair\/SKILL\.md" --yes --force/)
assert.match(hostileRequest.prompt, /hermes-hub-gateway doctor --runtime hermes/)
assert.match(hostileRequest.prompt, /hermes-hub-gateway pair --runtime hermes/)
assert.match(hostileRequest.prompt, /Do not use npx/)
assert.match(hostileRequest.prompt, /Do not generate a helper or call install\.mjs directly/)
assert.match(hostileRequest.prompt, /Do not add an automatic retry, alternate URL, or pairing mutation/)
