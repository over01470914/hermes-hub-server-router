...
assert.match(hostileRequest.prompt, /請完成 Hermes Hub Gateway 安裝與配對/)
...
assert.match(hostileRequest.prompt, /由官方 CLI 處理/)
assert.doesNotMatch(hostileRequest.prompt, /\bskill\b|不要重試|僅執行一次|FAILED step|PAIRING_DIAGNOSIS/)
